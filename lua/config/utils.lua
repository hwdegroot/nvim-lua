...
local util, api, cmd, fn, lsp, keymap = vim.lsp.util, vim.api, vim.cmd, vim.fn, vim.lsp, vim.keymap.set
...
function U.map(mode, key, result, opts)
    ...
    keymap(mode, key, result, opts)
end

function U.inoremap(shortcut, command, opts)
    U.imap(shortcut, command, {
        noremap = true,
        silent = true,
        expr = false
    })
...
function U.vnoremap(shortcut, command, opts)
    U.vmap(shortcut, command, {
        noremap = true,
        silent = true,
        expr = false
    })
...
function U.nnoremap(shortcut, command, opts)
    U.nmap(shortcut, command, {
        noremap = true,
        silent = true,
        expr = false
    })
...
function U.xnoremap(shortcut, command, opts)
    U.xmap(shortcut, command, {
        noremap = true,
        silent = true,
        expr = false
    })
...
function U.nmap(shortcut, command, opts)
    U.map('n', shortcut, command, opts)
end

function U.imap(shortcut, command, opts)
    U.map('i', shortcut, command, opts)
end

function U.vmap(shortcut, command, opts)
    U.map('v', shortcut, command, opts)
end

function U.xmap(shortcut, command, opts)
    U.vmap(shortcut, command, opts)
    U.nmap(shortcut, command, opts)
    U.imap(shortcut, command, opts)
end
...
_G.folds_render = require('config.fold').render
